...
- (IBAction)marcograssi:(UIButton *)sender {
    
    UIApplication *application = [UIApplication sharedApplication];
    NSURL *URL = [NSURL URLWithString:@"https://twitter.com/marcograss"];
    [application openURL:URL options:@{} completionHandler:nil];
    
}

- (IBAction)qwertyoruiopz:(UIButton *)sender {
...
- (IBAction)substrate:(UISwitch *)sender {
...
- (IBAction)reinstall:(UISwitch *)sender {
...
- (IBAction)jailbreakSlider:(UISlider *)sender {
