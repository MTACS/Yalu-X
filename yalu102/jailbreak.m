        ...
        
        {
            ...
            }
            {
                if (ssh == 1) {
                    ...
                    copyfile(jl, "/Library/LaunchDaemons/dropbear22.plist", 0, COPYFILE_ALL);
                    chmod("/Library/LaunchDaemons/dropbear22.plist", 0644);
                    chown("/Library/LaunchDaemons/dropbear22.plist", 0, 0);
                }
            }
            {
