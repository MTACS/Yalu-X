        ...
        
        {
            ...
            
            {
                ...
                chown("/Library/LaunchDaemons/dropbear.plist", 0, 0);
                    ...
                    NSString* jlaunchctl = [execpath stringByAppendingPathComponent:@"dropbear-wifi.plist"];
                    char* jl = [jlaunchctl UTF8String];
                    unlink("/Library/LaunchDaemons/dropbear.plist");
                    copyfile(jl, "/Library/LaunchDaemons/dropbear-wifi.plist", 0, COPYFILE_ALL);
                    chmod("/Library/LaunchDaemons/dropbear-wifi.plist", 0644);
                    chown("/Library/LaunchDaemons/dropbear-wifi.plist", 0, 0);
